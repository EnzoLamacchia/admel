              ...
              >
                <div class="px-4 py-5 flex-auto">
                  ...
                  <p class="mt-2 mb-4 text-gray-600">
                    Sempre impegnati al massimo su ciascun obiettivo</br>
                    Investi su di noi!
                  </p>
                </div>
              </div>
            ...
            <div class="w-full md:w-4/12 px-4 text-center">
              ...
              >
                <div class="px-4 py-5 flex-auto">
                  ...
                  <p class="mt-2 mb-4 text-gray-600">
                    Ogni progetto è costruito a misura del cliente. </br>
                    Amiamo definirci sartoriali in quello che produciamo
                  </p>
                </div>
              </div>
            </div>
