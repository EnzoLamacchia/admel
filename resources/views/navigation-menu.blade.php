<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                <!-- Logo -->
                <div class="shrink-0 flex items-center h-6 w-auto">
...
{{--                        <x-jet-authentication-card-logo class="block h-9 w-auto"/>--}}
                ...
                @if(auth()->user()->can('Super Amministratore') || auth()->user()->hasanyrole('amministratore|gestione utenti'))
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-jet-nav-link href="{{ route('gestione') }}" :active="request()->routeIs('gestione')">
                            {{ __('Gestione') }}
                        </x-jet-nav-link>
                    </div>
                @endif
