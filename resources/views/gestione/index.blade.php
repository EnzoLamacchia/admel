                ...
                <div class="flex flex-col md:flex-row w-full bg-white px-6 py-8 rounded-md">
                        ...
                        <div id="main" class="main-content flex-1 mt-12 md:mt-2 pb-24 md:pb-5">
                            ...
                            <div class="flex flex-wrap">
                                <div class="w-full md:w-1/2 xl:w-1/3 pr-3 pt-3">
                                    <!--Metric Card-->
                                        ...
                                        <div class="flex flex-row items-center">
                                            <div class="flex-shrink pr-4">
                                                <div class="rounded-full p-5 bg-pink-600">
                                                    <a href="{{route('gestioneutenti')}}"><i class="fas fa-users fa-2x fa-inverse"></i></a>
                                                </div>
                                            </div>
                                            <div class="flex-1 text-right md:text-center">
                                                <h2 class="font-bold uppercase text-gray-600">Utenti Totali</h2>
                                                <p class="font-bold text-3xl">{{$nrutenti}} <span class="text-pink-500"><i class="fas fa-exchange-alt"></i></span></p>
                                            </div>
                                        </div>
                                    </div>
                                    <!--/Metric Card-->
                                        ...
                                        <div class="flex flex-row items-center">
                                            <div class="flex-shrink pr-4">
                                                <div class="rounded-full p-5 bg-yellow-600">
                                                    <a href="{{route('creautente')}}"><i class="fas fa-user-plus fa-2x fa-inverse"></i></a>
                                                </div>
                                            </div>
                                            <div class="flex-1 text-right md:text-center">
                                                <h2 class="font-bold uppercase text-gray-600">Nuovi Utenti</h2>
                                                <p class="font-bold text-3xl">{{$nuoviutenti}} <span class="text-yellow-600"><i class="fas fa-caret-up"></i></span></p>
                                            </div>
                                        </div>
                                    </div>
                                    <!--/Metric Card-->
                                </div>
                                <div class="w-full md:w-1/2 xl:w-1/3 pr-3 pt-6">
                                    <!--Metric Card-->
                                    <div class="bg-gradient-to-b from-blue-200 to-blue-100 border-b-4 border-blue-500 rounded-lg shadow-xl p-5">
                                        <div class="flex flex-row items-center">
                                            ...
                                            <div class="flex-1 text-right md:text-center">
                                                ...
                                                <p class="font-bold text-3xl">{{$uptime}} </p>
                                            </div>
                                        </div>
                                    </div>
                                    <!--/Metric Card-->
